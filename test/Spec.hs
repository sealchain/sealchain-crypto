...
import           Seal.Crypto.Wallet.Encrypted
import qualified Seal.Crypto.Wallet.Pure as PureWallet
...
import qualified Seal.Crypto.Encoding.Seed as PW

import qualified Test.Crypto as Crypto
import qualified Test.Seal as Seal
...
main :: IO ()
main = defaultMain $ Group "sealchain-crypto"
